...
template<FloatingPoint Type> static inline constexpr Type SQRT_TWO_REC_T = (Type)1.0 / SQRT_TWO_T<Type>;
...
static inline constexpr F64 SQRT_TWO_REC_F = SQRT_TWO_REC_T<F32>;
static inline constexpr F64 SQRT_TWO_REC = SQRT_TWO_REC_T<F64>;
